...
class WebDriverAgent {
  ...
  async createTestRunner (proxy, opts = {}) {
    ...
    if (opts.launchSystem === 'xcodebuild') {
      testrunner = new XcodeBuild(opts.xcodeVersion, {
        udid: opts.udid,
        platformVersion: opts.platformVersion,
        agentPath: opts.agentPath,
        bootstrapPath: opts.bootstrapPath,
        realDevice: opts.realDevice,
        ...
        useSimpleBuildTest: opts.useSimpleBuildTest,
        usePrebuiltWDA: opts.usePrebuiltWDA,
        updatedWDABundleId: opts.updatedWDABundleId,
        launchTimeout: opts.wdaLaunchTimeout,
        wdaRemotePort: opts.wdaRemotePort,
      });
    } else {
